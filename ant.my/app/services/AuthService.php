...
class AuthService
{
    ...
    public function getUserSessions()
    {
        ...
        // Получаем все непросроченные токены пользователя
        $tokens = $db->fetchAll(
        ...
        // Обрабатываем каждый токен: парсим UserAgent и помечаем текущую сессию
 ...
 */
    ...
    public function parseUserAgent( $ua )
    {
        ...
        // 1. Определяем ОС (убраны пробелы в регулярках)
